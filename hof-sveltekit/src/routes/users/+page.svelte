...
<svelte:head>
  <title>Community - CPX Lab</title>
  <meta name="description" content="Connect with fellow researchers and lab members" />
</svelte:head>
  ...
  <div class="bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-gray-900 mb-4" style="font-size: var(--text-4xl);">Community</h1>
        <p class="text-xl text-gray-600 mb-8" style="font-size: var(--text-xl);">Connect with fellow researchers and lab members</p>
      </div>
    </div>
  </div>
